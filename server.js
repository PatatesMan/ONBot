...
const embedlulz = new Discord.RichEmbed()
    .setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor!")
      .setColor(0x00AE86)
      .setDescription("o.uyar <kişi> komutu ile onu uyarabilir ya da o.kick <kişi> veya o.ban <kişi> komutlarını kullanarak onu sunucudan uzaklaştırabilirsin!")
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa') {
    msg.reply('Aleyküm selam,  hoş geldin  Nasılsın ^_^');
  }
});
